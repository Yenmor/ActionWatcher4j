...
public class ScreenCatch {
    ...
    public ScreenCatch(String s, String format) {
        filePreStr = s;
        imageFormat = format;
    }
    ...
    public File snapShot() {
        try {
            ...
            String name = filePreStr + String.valueOf(serialNum) +DateGeter.GetDate()+ "." + imageFormat;
...
//    	ScreenCatch cam = new ScreenCatch("d:\\Hello", "png");//
//        cam.snapShot();
//    }
}
